...
## 1.1 Objective: <!-- Do not use semicolon in section titles -->
...
## 2.1 Pearson Diagram: Backround <!-- Typo --> and Components <!-- Typo -->
...
<!-- usually, we denote the sample variance as s^2. Improve punctuation after displayed equations -->
where, 
...
$$\bar{x} = \frac{\sum_{i=1}^{n} x_i}{n}$$
   ...
   <!-- why is beta in parenthesis? Use a consistent notation -->
...
<!-- kurtosis is a word, not the product of k, u, r etc. Type it in text mode, or use standard notation -->
...
<!-- Does the Pearson plot show the mean and the variance? -->

#### 2.3 Plotting using the Pearson Diagram

The Pearson diagram represents skewness on the x-axis and kurtosis on the y-axis. 
<!-- Use a consistent notation; x and y should be in math mode -->
Points matching to various distributions can be plotted using the determined skewness and kurtosis.
...
<!-- Parentheses must be preceded by a space -->
...
* **Core Functions:**
<!-- Use a different typography for functions, e.g., texttt   -->
